...
### Companion to Unified Part 7: options income, matrix risk and tax cases
...
\[
\mathbf{\Sigma} = [\sigma_{ij}], \qquad \sigma_{ij}=\sigma_i\sigma_j\rho_{ij}.
\]
...
| Strike | % out-of-the-money | Premium | Collateral | Period yield on collateral | Naive annualized (times12) |
|---|---|---|---|---|---|
...
\[
Disallowed portion = Total loss \times (shares repurchased / shares sold) = $1,000 \times (40/100) = $400
\]
