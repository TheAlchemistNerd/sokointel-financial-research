...
### Companion to Unified Part 6: satellites, thematic exposure and concentration
...
For a fund holding exactly N positions at equal weight, each holding's weight is w_i = 1/N. Substituting into Equation 3.1:

\[
HHI = \sum_{i=1}^{N}\left(\frac{1}{N}\right)^2 = N\left(\frac{1}{N^2}\right) = \frac{1}{N}
\]

Applying Equation 3.2:

\[
N_{\mathrm{eff}} = \frac{1}{HHI} = \frac{1}{1/N} = N
\]
