# Part 3 — Semiconductor ETFs as a Satellite: SOXQ, SOXX, SMH and XSD Are Not the Same Trade

## Series scope

The supplied semiconductor research note asked a practical question: **which semiconductor ETF has the same low-cost, efficient character as QQQM and SPYM?** The first-pass answer was SOXQ because its current stated expense ratio is lower than the larger legacy semiconductor funds. That conclusion is directionally useful but incomplete. A sector ETF is not selected by price alone. The index methodology determines what the investor actually owns, how concentrated the exposure becomes, and how the sleeve interacts with the broad U.S. core established in Parts 1 and 2.
...
## 14. A practical selection scorecard
...
## 15. An illustrative allocation decision
...
## 16. Rebalancing a volatile satellite
...
## 17. What would change the choice?
...
The 2025–2026 QQQ structural change discussed in Part 1 is a good precedent: a comparison that was correct in an older research note can become stale. Fund due diligence is not a one-time event.
...
Most importantly, a semiconductor ETF should be sized from the **portfolio level**. SPYM and QQQM already contain semiconductor exposure. The satellite adds to that look-through weight and can increase dependence on the same mega-cap growth drivers. Part 4 turns to the other major satellite in the supplied notes: the option wheel, where the central risk is not index overlap but the obligation created by selling options.
